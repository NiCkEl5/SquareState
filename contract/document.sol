	...
	*/
	...
	contract Property is ERC721Token, Ownable {
	  ...
	  uint256 constant PROPERTY_DETAILS_MIN_LENGTH = 1;
	  uint256 constant PROPERTY_DETAILS_MAX_LENGTH = 10000;
	  ...
	  constructor() ERC721Token("Property", "SQST") public {
	  ...
	  /// @param _propertyID Legal ID of the property
	  /// @param _details Details of the property
	  ...
	  /// Requires the amount of Ether be at least or more of the currentPrice
	  /// @dev Buy token and move it to buyer wallet
	  /// @param _tokenID ID of the token to be bought
	  function buyToken (
		uint256 _tokenID
	  ) external payable {
        ...
        emit boughtToken(msg.sender, _tokenID);
	  }
	  ...
	  function viewToken(uint256 _tokenId)
		...
		view
		returns (
		  string tokenPropertyID_,
		  string tokenPropertyDetail_,
		  uint256 tokenPropertyPrice_
	  ) {
		  tokenPropertyID_ = tokenPropertyIDs[_tokenId];
		  tokenPropertyDetail_ = tokenPropertyDetails[_tokenId];
		  tokenPropertyPrice_ = tokenPropertyPrices[_tokenId];
	  }
